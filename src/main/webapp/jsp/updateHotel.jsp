                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="/hoteljyf/update" method="post">
                                <input type="hidden" name="hotelid" value="${findbyid.hotelid}">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-control-label">酒店名称</label>
                                                <input type="text" class="form-control" value="${findbyid.hotelname}"
                                                       name="hotelname">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="${findbyid.hoteladdress}"
                                                       name="hoteladdress">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="single-select" class="form-control" name="hotelclassid">
                                                    <sh:forEach items="${findall}" var="obj">
                                                        <option value="${obj.hotelclassid}"
                                                                <sh:if test="${findbyid.hotelclassid eq obj.hotelclassid}">selected</sh:if> >${obj.hotelclassname}</option>
                                                    </sh:forEach>
                                                </select>
                                            </div>
